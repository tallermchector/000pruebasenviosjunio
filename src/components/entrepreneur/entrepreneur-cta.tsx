      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-6xl font-black italic tracking-tighter leading-none mb-8 uppercase text-white">
            ...
            TU <span className="text-primary drop-shadow-[0_0_20px_rgba(59,130,246,0.4)]">E-COMMERCE?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a
              ...
              className="px-12 py-5 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-display font-bold rounded-xl transition-all flex items-center gap-3 uppercase tracking-tight group h-auto text-center"
            >
