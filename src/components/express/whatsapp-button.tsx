...
export function WhatsAppButton() {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="lg"
      className="bg-white/5 border border-white/10 text-white hover:text-white hover:bg-white/10 font-display font-bold px-8 py-4 rounded-xl transition-all uppercase tracking-tight h-auto"
    >
