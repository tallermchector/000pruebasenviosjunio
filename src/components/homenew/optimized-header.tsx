  ...
  return (
    <HeaderContainer>
      ...
      <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group shrink-0 min-w-0" aria-label="Volver al inicio desde la cabecera">
        ...
        <span className="font-display text-orbitron font-black text-sm sm:text-lg md:text-2xl tracking-tighter text-foreground uppercase italic whitespace-nowrap">
          Envíos<span className="text-secondary drop-shadow-[0_0_10px_rgba(255,230,0,0.35)] font-display">Dosruedas</span>
        </span>
      </Link>
