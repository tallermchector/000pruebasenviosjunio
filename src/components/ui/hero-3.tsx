...
const ActionButton = ({ children }: { children: React.ReactNode }) => (
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    className="mt-8 px-8 py-3 rounded-md bg-primary text-primary-foreground font-semibold shadow-lg transition-all hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-opacity-75 font-display text-label-md uppercase tracking-wide"
  >
    {children}
  </motion.button>
);
